...
class UserTest < ActiveSupport::TestCase
  ...
  test "email validation should accept valid addresses" do
    valid_addresses = %w(user@examile.com USER@foo.com A_US-ER@foo.bar.org first.last@foo.jp alice+bob@baz.cn)
  ...
  test "authenticated? should return falst for a user with nil digest" do
  ...
  test "feed should have the right posts" do
    user1 = users(:admin_user)
    user2 = users(:test_user)
    user3 = users(:test_user_2)
